...
function writeBigVarintHigh(t, e) {
    ...
    t && (e.buf[e.pos++] = 127 & t | ((t >>>= 7) ? 128 : 0), t && (e.buf[e.pos++] = 127 & t | ((t >>>= 7) ? 128 : 0), t && (e.buf[e.pos++] = 127 & t | ((t >>>= 7) ? 128 : 0), t && (e.buf[e.pos++] = 127 & t | ((t >>>= 7) ? 128 : 0), t && (e.buf[e.pos++] = 127 & t)))))
}
...
function readUtf8(t, e, r) {
    ...
    n = e; n < r;) {
        ...
        if (n + s > r) break;
        var u, c, h;
        1 === s ? o < 128 && (a = o) : 2 === s ? (u = t[n + 1], 128 === (192 & u) && (a = (31 & o) << 6 | 63 & u, a <= 127 && (a = null))) : 3 === s ? (u = t[n + 1], c = t[n + 2], 128 === (192 & u) && 128 === (192 & c) && (a = (15 & o) << 12 | (63 & u) << 6 | 63 & c, (a <= 2047 || a >= 55296 && a <= 57343) && (a = null))) : 4 === s && (u = t[n + 1], c = t[n + 2], h = t[n + 3], 128 === (192 & u) && 128 === (192 & c) && 128 === (192 & h) && (a = (15 & o) << 18 | (63 & u) << 12 | (63 & c) << 6 | 63 & h, (a <= 65535 || a >= 1114112) && (a = null))),
        null === a ? (a = 65533, s = 1) : a > 65535 && (a -= 65536, i += String.fromCharCode(a >>> 10 & 1023 | 55296), a = 56320 | 1023 & a),
...
Pbf.prototype = {
    ...
    readVarint: function(t) {
        ...
        return r = i[this.pos++],
        e = 127 & r,
        r < 128 ? e: (r = i[this.pos++], e |= (127 & r) << 7, r < 128 ? e: (r = i[this.pos++], e |= (127 & r) << 14, r < 128 ? e: (r = i[this.pos++], e |= (127 & r) << 21, r < 128 ? e: (r = i[this.pos], e |= (15 & r) << 28, readVarintRemainder(e, t, this)))))
    },
    ...
    writeVarint: function(t) {
        return t = +t || 0,
        t > 268435455 || t < 0 ? void writeBigVarint(t, this) : (this.realloc(4), this.buf[this.pos++] = 127 & t | (t > 127 ? 128 : 0), void(t <= 127 || (this.buf[this.pos++] = 127 & (t >>>= 7) | (t > 127 ? 128 : 0), t <= 127 || (this.buf[this.pos++] = 127 & (t >>>= 7) | (t > 127 ? 128 : 0), t <= 127 || (this.buf[this.pos++] = t >>> 7 & 127)))))
    },
...
VectorTileFeature$2.prototype.toGeoJSON = function(t, e, r) {
    ...
    case 2:
        ...
        break;
    case 3:
        for (c = classifyRings(c), n = 0; n < c.length; n++) for (o = 0; o < c[n].length; o++) i(c[n][o])
    }
...
L.VectorGrid = L.GridLayer.extend({
    ...
    createTile: function(t, e) {
        ...
        return r && (this._vectorTiles[this._tileCoordsToKey(t)] = n, n._features = {}),
        o.then(function(i) {
            for (var o in i.layers) {
                ...
                for (var c in a.features) {
                    ...
                    if (f instanceof Function && (f = f(l.properties, t.z)), f instanceof Array || (f = [f]), f.length) {
                        ...
                        var type = l.type ==1 ? "point":  l.type == 2 ? "PolylineLayer" : l.type == 3 ? "PolygonLayer": "other";
                        for (var y in f) {
                            var v = L.extend({},
                            L.Path.prototype.options, f[y]);
                            d.render(n, v),
                            n._addPath(d)
                        }
...
var FeatureLayer = L.Class.extend({
    ...
    _getPixelBounds: function() {
        ...
        e = L.bounds([]), r = 0; r < t.length; r++) for (var i = t[r], n = 0; n < i.length; n++) e.extend(i[n]);
    ...
    /*_makeFeatureParts: function(feat, pxPerExtent) {
        ...
        for (var n in i) {
            ...
            for (var s in o){
            	r = o[s];
            	if("x" in r){
            		a.push(L.point(r.x * pxPerExtent, r.y * pxPerExtent))
            	}else{
            		a.push(L.point(r[0] * pxPerExtent, r[1] * pxPerExtent))
            	};
            	this._parts.push(a)
            }
        }
...
L.VectorGrid.Slicer = L.VectorGrid.extend({
    ...
    _getVectorTilePromise: function(t) {
        ...
        r = new Promise(function(r) {
            e._worker.addEventListener("message",
            function i(n) {
...
L.Canvas.Tile = L.Canvas.extend({
    ...
    _onClick: function(t) {
        ...
        e.options.interactive && e._containsPoint(r) && !this._map._draggableMoved(e) && (L.DomEvent._fakeStop(t), i.push(e));
    ...
    _updateIcon: function(t) {
        if (this._drawing) {
            ...
            a = this._ctx,
            s = t._getImage();
            s.complete ? a.drawImage(s, o.x, o.y, i.x, i.y) : L.DomEvent.on(s, "load",
            function() {
