...
<head>
	...
	<link href="${ctx}/css/FrameUI.css" rel="stylesheet"/>
	
	<script type="text/javascript" src="${ctx}/js/lib/bootstrap/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="${ctx}/js/lib/bootstrap/js/adminlte.min.js"></script>
	<script type="text/javascript" src="${ctx}/js/main/mainFrame.js"></script>
...
<div class="wrapper" id="mainWrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a ><i class="fa fa-circle-o"></i> 常规</a></li>
            <li><a ><i class="fa fa-circle-o"></i> 图标</a></li>
            <li><a ><i class="fa fa-circle-o"></i> 按钮</a></li>
            <li><a ><i class="fa fa-circle-o"></i> 活动</a></li>
            <li><a ><i class="fa fa-circle-o"></i> 时间线</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
  ...
  <div class="content-wrapper">
    <section class="content-header" style="border-bottom: 1px solid #d2d6de;padding-bottom: 10px;background-color: #fff;">
      <ol class="breadcrumb">
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
     ...
     <strong>Copyright &copy; 2014-2016 <a href="https://adminlte.io">zhengang.he</a>.</strong> All rights reserved.
  </footer>
